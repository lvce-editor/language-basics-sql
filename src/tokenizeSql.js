...
const RE_BUILTIN_FUNCTION =
  /^(?:abs|acos|asin|atan|atn2|ceiling|cos|cot|dense_rank|degrees|exp|floor|log|log10|ntile|pi|power|radians|rand|rank|round|row_number|sign|sin|sqrt|square|tan)\b/i
const RE_ANYTHING = /^.+/s
